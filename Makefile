...
STAGE0_OUTPUT    = stage0/hollywood-$(TCPH_KERNEL_REV).tar.gz
...
all: $(STAGE0_OUTPUT) $(STAGE1_OUTPUT) $(STAGE2_OUTPUT) $(STAGE3_OUTPUT) $(STAGE4_OUTPUT) $(GRAPHICS_GENERATED) $(TEX_BASE).pdf
...
stage0/hollywood-$(TCPH_KERNEL_REV).tar.gz: stage0/Vagrantfile stage0/bin/fetch-tcph.sh
	@echo "================================================================================"
	@echo "== Building $@"
...
clean: stage0-clean stage1-clean stage2-clean stage3-clean stage4-clean stage5-clean stage6-clean
